...
export default async function EditProductPage({
	...
	const product = await getProduct({ id: productId, userId: session.userId });
		...
		>
			<Tabs defaultValue={tab}>
				...
				<TabsContent value="countries">
					<CountryTab productId={productId} userId={session.userId} />
				</TabsContent>
				<TabsContent value="customization">
					<CustomizationsTab productId={productId} userId={session.userId} />
				</TabsContent>
			</Tabs>
		</PageWithBackButton>
	);
