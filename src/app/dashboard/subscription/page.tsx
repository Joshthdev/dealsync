				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					<Card>
						...
						<CardContent>
							<Progress
								value={
									tier.maxNumberOfVisits
										? (pricingViewCount / tier.maxNumberOfVisits) * 100
										: 0
								}
							/>
						</CardContent>
					...
					<Card>
						...
						<CardContent>
							<Progress
								value={
									tier.maxNumberOfProducts
										? (productCount / tier.maxNumberOfProducts) * 100
										: 0
								}
							/>
						</CardContent>
	...
	return (
		<Card className="shadow-none rounded-3xl overflow-hidden">
			...
			<CardFooter className="flex flex-col gap-4 items-start">
				...
				{canRemoveBranding && <Feature>Remove PriceVerve branding</Feature>}
			</CardFooter>
		</Card>
	);
}
